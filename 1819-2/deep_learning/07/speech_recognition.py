...
class Network:
    def __init__(self, args):
        ...
        prev = inputs = tf.keras.Input(shape=(None, TimitMFCC.MFCC_DIM))
        prev = tf.keras.Dense(50, activation=tf.nn.relu)(prev)
        outputs = tf.keras.Dense(len(TimitMFCC.LETTERS)+1, activation=None)(prev)
